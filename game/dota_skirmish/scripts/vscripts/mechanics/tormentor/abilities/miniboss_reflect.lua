LinkLuaModifier("modifier_miniboss_reflect_custom", "mechanics/tormentor/abilities/miniboss_reflect.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_miniboss_reflect_custom:OnTakeDamage(keys)
	...
	-- Need to find sound name
	-- self.parent:EmitSound("")
