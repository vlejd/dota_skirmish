LinkLuaModifier("modifier_roshan_inherent_buffs_custom", "mechanics/roshan/abilities/roshan_inherent_buffs.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_roshan_inherent_buffs_custom:OnIntervalThink()
	...
	local minutes = math.floor(time.skirmishTime / self.interval)
