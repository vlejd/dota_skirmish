local GameState = {
    ...
    wards = {
        {
            type = "npc_dota_ward_base_truesight",
            position = Vector(3714.263916015625,-974.029541015625,0),
          },
    {
            type = "npc_dota_ward_base",
            position = Vector(468.93310546875,3964.9658203125,0),
          },
    {
            type = "npc_dota_ward_base_truesight",
            position = Vector(465.8203125,3982.513427734375,0),
          },
    {
            type = "npc_dota_ward_base_truesight",
            position = Vector(3298.980712890625,4045.928955078125,0),
          },
    {
            type = "npc_dota_ward_base_truesight",
            position = Vector(1314.971923828125,2310.821533203125,0),
          },
    {
            type = "npc_dota_ward_base_truesight",
            position = Vector(-747.49755859375,2039.215087890625,0),
          },
    {
            type = "npc_dota_ward_base",
            position = Vector(-747.49755859375,2039.215087890625,0),
    ...
    {
            type = "npc_dota_ward_base_truesight",
            position = Vector(-4018.341064453125,1496.2158203125,0),
          },
    {
            type = "npc_dota_ward_base",
            position = Vector(-4026.824951171875,1449.64599609375,0),
          },
    {
            type = "npc_dota_ward_base",
            position = Vector(-2064.483642578125,213.68408203125,0),
          },
    {
            type = "npc_dota_ward_base_truesight",
            position = Vector(-1891.6015625,-5.126953125,0),
          },
    {
            type = "npc_dota_ward_base_truesight",
            position = Vector(-2773.3154296875,3488.922119140625,0),
          },
    {
            type = "npc_dota_ward_base",
            position = Vector(-1401.123046875,4106.01806640625,0),
          },
    },
    roshan = {
        deaths = 2
