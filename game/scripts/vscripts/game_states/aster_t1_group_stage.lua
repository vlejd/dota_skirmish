local GameState = {
    ...
    wards = {
        {
            ...
            team = 2,
            position = Vector(3714.031774520874,-973.9686641693115,1000),
          },
    {
            type = "npc_dota_observer_wards",
            team = 3,
            position = Vector(468.9037971496582,3964.7180099487305,1000),
          },
    {
            type = "npc_dota_sentry_wards",
            team = 3,
            position = Vector(465.79119873046875,3982.2645206451416,1000),
          },
    {
            type = "npc_dota_sentry_wards",
            team = 3,
            position = Vector(3298.7745265960693,4045.6760845184326,1000),
          },
    {
            type = "npc_dota_sentry_wards",
            team = 3,
            position = Vector(1314.8897380828857,2310.6771068573,1000),
          },
    {
            type = "npc_dota_sentry_wards",
            team = 3,
            position = Vector(-747.4508399963379,2039.0876369476318,1000),
          },
    {
            type = "npc_dota_observer_wards",
            team = 3,
          ...
          },
    {
            type = "npc_dota_sentry_wards",
            team = 2,
            position = Vector(-4018.0899181365967,1496.1223068237305,1000),
          },
    {
            type = "npc_dota_observer_wards",
            team = 2,
            position = Vector(-4026.5732746124268,1449.5553932189941,1000),
          },
    {
            type = "npc_dota_observer_wards",
            team = 2,
            position = Vector(-2064.354612350464,213.67072677612305,1000),
          },
    {
            type = "npc_dota_sentry_wards",
            team = 2,
            position = Vector(-1891.4833374023438,-5.1266326904296875,1000),
          },
    {
            type = "npc_dota_sentry_wards",
            team = 2,
            position = Vector(-2773.1420974731445,3488.7040615081787,1000),
          },
    {
            type = "npc_dota_observer_wards",
            team = 2,
            position = Vector(-1401.0354766845703,4105.7614402771,1000),
          },
  },
    roshan = {
        deaths = 2
    ...
    neutrals = {
		good = { "item_trusty_shovel", "item_pogo_stick", "item_possessed_mask", "item_arcane_ring", "item_unstable_wand", "item_pupils_gift", "item_vambrace", "item_quicksilver_amulet", "item_philosophers_stone", "item_dragon_scale", "item_enchanted_quiver", "item_psychic_headband", "item_cloak_of_flames"
		},
		bad = { "item_possessed_mask", "item_pogo_stick", "item_keen_optic", "item_ocean_heart", "item_chipped_vest", "item_grove_bow", "item_nether_shawl", "item_essence_ring", "item_misericorde", "item_pupils_gift", "item_cloak_of_flames", "item_mind_breaker", "item_stormcrafter"
		},
	},
    wincon = nil
}
